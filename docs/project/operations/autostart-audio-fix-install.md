...
#### Файл: [`verter_admin/src/verter_admin/text_to_speech/text_to_speech_node.py`](verter_admin/src/verter_admin/text_to_speech/text_to_speech_node.py:126)
```python
# Было:
...
#### Файл: [`verter_admin/src/verter_admin/sound_player/sound_player_node.py`](verter_admin/src/verter_admin/sound_player/sound_player_node.py:112)
```python
...
#### Файл: [`verter_admin/src/verter_admin/text_to_speech/text_to_speech_node.py`](verter_admin/src/verter_admin/text_to_speech/text_to_speech_node.py:79)
```python
# Добавлено:
self.env["PULSE_LATENCY_MSEC"] = "100"  # Было 30
```

#### Файл: [`verter_admin/src/verter_admin/sound_player/sound_player_node.py`](verter_admin/src/verter_admin/sound_player/sound_player_node.py:65)
```python
# Было:
...
#### Файл: [`verter_admin/services/start_verter_admin.sh`](verter_admin/services/start_verter_admin.sh:49)
```bash
...
#### Файл: [`verter_admin/services/start_verter_admin.sh`](verter_admin/services/start_verter_admin.sh:63)
```bash
...
#### Файл: [`verter_admin/services/verter-admin.service`](verter_admin/services/verter-admin.service:3)
```ini
# Было:
