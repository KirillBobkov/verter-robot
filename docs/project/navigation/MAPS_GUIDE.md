...
## 📋 Содержание
1. [Сохранение карты](#sohranenie-karty)
2. [Загрузка карты](#zagruzka-karty)
3. [Переключение режимов](#perekluchchenie-rezhimov)
4. [Примеры использования](#primery-ispolzovaniya)

---

## 💾 Сохранение карты {#sohranenie-karty}
...
## 🔀 Переключение режимов SLAM {#perekluchchenie-rezhimov}
