...
| `REMINDER_INTERVAL` | 180.0 с | Интервал напоминания пользователю в пассивном режиме |
...
| Напоминание | — | `speech_control=False` (возобновит TTS после озвучки) |

!!! warning "Магическое число 0.1с"
    `time.sleep(0.1)` после синтеза — защита от эха. Для длинных фраз может быть недостаточно. См. [refactor_notes.md](refactor_notes.md).

## STT-параметры VAD (по движкам)

| Параметр | CTC | Sherpa | Transducer | Parakeet |
|----------|-----|--------|------------|----------|
| `BLOCK_SIZE` | 512 (32мс) | 512 (32мс) | 1600 (100мс) | 1600 (100мс) |
| `VAD_THRESHOLD` | 0.7 | 0.7 | 0.5 | 0.5 |
| `SILENCE_CHUNKS` | ~22 (0.7с) | ~22 (0.7с) | 4 (0.4с) | 6 (0.6с) |
| `PRE_BUFFER` | 0.5с | 0.5с | 5 чанков | 5 чанков |
| `NUM_THREADS` | 4 | 6 | 4 | 4 |
| `AUDIO_LATENCY` | 0.0 | — | 0.2 | 0.2 |
